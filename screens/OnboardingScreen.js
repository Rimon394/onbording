    ...
    <View style={styles.container}>
        ...
        pages={[
...

              {
                    ...
                    image:(
                      <View  style={styles.lottie }>
                      <Lottie source={require('../Assets/Animation/animation_lkc8ccy5.json')} autoPlay loop />
...

              {
                    ...
                    image:(
                      <View  style={styles.lottie }>
                          <Lottie source={require('../Assets/Animation/animation_lkc89tt9.json')} autoPlay loop />
